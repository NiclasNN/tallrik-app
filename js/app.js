...
import { state, load, subscribe, save, migrateLegacy, activeUser, needsPin, users, commit, restoreFromIDBIfEmpty, setSetting, createUser, setActiveUser, touchUnlock, mergeSharedBackup, prunePhotos } from './store.js?v=202609141620';
import * as Users from './ui/users.js?v=202609141620';
import { I } from './icons.js?v=202609141620';
import { esc, todayKey, closeAllSheets, debounce, guessMeal, setDocumentTheme, resolveTheme, IS_IOS, IS_STANDALONE, IS_LOCAL_HOST, PUBLIC_URL } from './components.js?v=202609141620';
import { loadDB } from './foods.js?v=202609141620';
import { processQueue, aiStatus, syncKeysWithHost, ensureModels, loadBundledKeys } from './ai.js?v=202609141620';
import { backupOnStart } from './backup.js?v=202609141620';
import * as Onboarding from './ui/onboarding.js?v=202609141620';
import * as Home from './ui/home.js?v=202609141620';
import * as Log from './ui/log.js?v=202609141620';
import * as Suggest from './ui/suggest.js?v=202609141620';
import * as Progress from './ui/progress.js?v=202609141620';
import * as Profile from './ui/profile.js?v=202609141620';
...
if (invited) setTimeout(() => import('./components.js?v=202609141620').then(m => m.toast(invited.isNew ? `Välkommen ${invited.name}! Det här är din egen Tallrik` : `Välkommen tillbaka, ${invited.name}`, 'good', 4000)), 600);
...
function toastKeys(msg = 'AI-nycklar hämtade från din andra enhet') { import('./components.js?v=202609141620').then(m => m.toast(msg, 'good')); }
...
function bootError(e) {
  ...
  root.querySelector('#err-reset').onclick = () => { if (confirm('Nollställa den här profilen? All dess historik raderas.')) { import('./store.js?v=202609141620').then(m => { m.resetAll(); location.reload(); }); } };
}
