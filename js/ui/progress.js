...
import { state, dayTotals, setTargets, latestWeight, firstWeight, removeWeight } from '../store.js?v=202609141620';
import { esc, fmt, signed, todayKey, addDays, fmtShort, weekdayShort, haptic, toast, openSheet, segmented, bindSeg, confirmSheet, animateIn, fmtDate, parseKey, dateKey, cute } from '../components.js?v=202609141620';
import * as Home from './home.js?v=202609141620';
import { navigate } from '../app.js?v=202609141620';
import { I } from '../icons.js?v=202609141620';
import { adaptiveTDEE, computeTargets, weightTrend, bmi, bmiLabel } from '../nutrition.js?v=202609141620';
...
function weightView() {
  ...
  return `<div class="card">
      <div class="row between mb-2"><div><div class="eyebrow">Nuvarande</div><div class="hero-num">${lw ? fmt(lw.kg, 1) : '–'} <small style="font-size:14px;color:var(--text-3)">kg</small></div></div>
        <div>${segmented([{ id: '30', name: '30d' }, { id: '90', name: '90d' }, { id: '365', name: 'År' }, { id: '3650', name: 'Allt' }], String(range), 'data-range')}</div></div>
