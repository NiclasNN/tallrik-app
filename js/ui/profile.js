...
import { state, setProfile, setTargets, setSetting, exportJSON, importJSON, resetAll, users, activeUser, setPin, checkPin, updateUser, deleteUser, createUser, storageInfo } from '../store.js?v=202609171301';
import { showUsers } from '../app.js?v=202609171301';
import { esc, fmt, haptic, toast, openSheet, confirmSheet, segmented, bindSeg, initials, fmtDateLong, themePicker, bindThemePicker, isCute, PUBLIC_URL, IS_LOCAL_HOST } from '../components.js?v=202609171301';
import { I } from '../icons.js?v=202609171301';
import { backupConfig, setBackupConfig, disconnectBackup, backupNow, listBackups, restoreBackup, DEFAULT_REPO } from '../backup.js?v=202609171301';
import { ACTIVITY, GOALS, PACES, DIETS, AVOID, computeTargets } from '../nutrition.js?v=202609171301';
import { PROVIDERS, aiStatus, addKey, removeKey, setProvider, setMode, setModelChoice, availableModels, pickModel, setTextProvider } from '../ai.js?v=202609171301';
import { dbMeta } from '../foods.js?v=202609171301';

export function render(root) {
  const bothKeys = !!((state.settings.ai?.keys?.gemini || '').trim() && (state.settings.ai?.keys?.groq || '').trim());
  ...
  root.innerHTML = `<div class="page">
    ...
    <div class="section" id="ai-card">
      ...
      <div class="card">
        ...
        <button class="btn sm block mt-2" id="share-keys">💌 Bjud in – egen app till någon annan</button>
        ${bothKeys ? '<details class="more mt-2"><summary>AI-inställningar och nycklar</summary>' : ''}
